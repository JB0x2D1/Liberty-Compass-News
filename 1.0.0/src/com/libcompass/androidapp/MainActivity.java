...
public class MainActivity extends Activity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_home) { // load the home page in the main webview
        	...
        	} else Toast.makeText(this, "Can't reach LibCompass.com", Toast.LENGTH_LONG).show();
            return true;
        }
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			if (webViewBundle != null) {
				...
				if (networkAvailable(super.getActivity().getBaseContext())) {
					...
					Toast.makeText(getActivity(), "Can't reach LibCompass.com", Toast.LENGTH_LONG).show();
    ...
    protected static boolean networkAvailable(Context context) {
		...
		if (activeNetworkInfo != null && activeNetworkInfo.isConnected()) {
			Thread t = new Thread() {
	    		public void run() {
	    			try {
			            URL url = new URL("http://www.libcompass.com");
